package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private var var_1886:uint;
      
      protected var var_8:WindowController;
      
      protected var var_752:uint = 10;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_370 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_55 = var_370.clone();
            var_7 = var_370.clone();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_106,WindowParam.const_140);
         var _loc2_:* = !testParamFlag(WindowParam.const_114,WindowParam.const_143);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
      ...
      {
         var_755 = param1;
         var_625 = !!var_755 ? uint(var_625 | var_1379) : uint(var_625 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1886 + "]";
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_7,WindowRedrawFlag.const_964);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1008 || _loc3_.hasGraphicsContext())
         {
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_752);
      }
               ...
               case MouseEvent.MOUSE_DOWN:
                  ...
                  if((var_17 & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        ...
                        {
                           _context.getWindowServices().getMouseScalingService().begin(_loc5_,var_17 & 0);
                           break;
                        }
                        _loc5_ = _loc5_.parent;
                     }
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_211:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_392,this,null));
                     if(testParamFlag(WindowParam.const_177,WindowParam.const_140))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_170,WindowParam.const_143))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                     {
                        ...
                        var_17 = _loc8_;
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_256,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_395:
                  _context.invalidate(this,var_7.union(var_55),WindowRedrawFlag.const_454);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_807,this,null));
                     if(var_8 != null)
                     {
               ...
               case WindowNotifyEvent.const_308:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_627,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_226,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_469:
                  _context.invalidate(this,var_7,WindowRedrawFlag.const_810);
                  break;
               case WindowNotifyEvent.const_387:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_358:
                  if(!(var_17 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_7,WindowRedrawFlag.const_454);
                     }
                  }
                  else if(var_17 & 0)
                  {
      ...
      public function maximize() : Boolean
      {
         ...
         setStateFlag(WindowState.const_65,true);
         _loc1_.type = WindowNotifyEvent.const_840;
         update(this,_loc1_);
         return true;
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_752);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_719,this,param1));
         return param1;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1008 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            _loc7_ = uint(var_17 & 0);
            if(_loc7_ == WindowParam.const_364)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_411)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_544,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function lock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_65,true);
         _loc1_.type = WindowNotifyEvent.const_1249;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_161 && var_752 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_7.width && param1.y <= var_7.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1470,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1470,param3,param1)) : false;
            }
         }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            if(var_8 != null)
            {
               ...
               var_55.width = var_7.width;
               var_55.height = var_7.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_385,this,var_8));
            }
            else
            {
               var_304.x = 0;
      ...
      {
         var _loc3_:uint = var_17;
         var _loc4_:*;
         var_17 = !!param2 ? (_loc4_ = var_17 | param1, var_17 |= param1, uint(_loc4_)) : (_loc4_ = var_17 & ~param1, var_17 &= ~param1, uint(_loc4_));
         if(var_17 != _loc3_)
         {
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,var_17,_context,var_7,null,var_620,properties,var_624.concat(),_id) as WindowController;
         _loc2_.var_752 = var_752;
         _loc2_.var_161 = var_161;
         _loc2_._debug = _debug;
         _loc2_.var_304 = var_304.clone();
         _loc2_.var_7 = var_7.clone();
         _loc2_.var_370 = var_370.clone();
      ...
      {
         var_752 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         if(var_36 == WindowState.const_369)
         {
            return true;
         }
