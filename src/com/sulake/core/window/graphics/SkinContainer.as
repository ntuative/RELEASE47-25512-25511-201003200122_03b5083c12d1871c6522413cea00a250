package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_2032 = new Dictionary();
         TypeCodeTable.fillTables(var_1515,var_2032);
         var_1263 = new Dictionary();
         var_2031 = new Dictionary();
         StateCodeTable.fillTables(var_1263,var_2031);
         var_504 = new Dictionary();
         var_504["skin"] = BitmapSkinRenderer;
         var_504["bitmap"] = BitmapDataRenderer;
         var_504["fill"] = FillSkinRenderer;
         var_504["text"] = TextSkinRenderer;
         var_504["shape"] = ShapeSkinRenderer;
         var_504["unknown"] = SkinRenderer;
         var_504["null"] = NullSkinRenderer;
         if(var_372 == null)
         {
            var_372 = new Array();
            var_372.push(WindowState.const_65);
            var_372.push(WindowState.const_69);
            var_372.push(WindowState.const_93);
            var_372.push(WindowState.const_48);
            var_372.push(WindowState.const_80);
            var_372.push(WindowState.const_72);
            var_372.push(WindowState.const_94);
            var_372.push(WindowState.const_85);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1263)
         {
            _loc3_.push(var_1263[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1515[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_591[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_591[param1] = new Array(SkinContainer.const_1095);
         }
         var_591[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_591[_loc1_]).dispose();
