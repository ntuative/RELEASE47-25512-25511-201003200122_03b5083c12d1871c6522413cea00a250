package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2339:Rectangle = new Rectangle();
      ...
      override public function dispose() : void
      {
         if(var_753)
         {
            context.removeLocalizationListener(var_324,this);
         }
         if(var_67 != null)
         {
            var_67.dispose();
      ...
      public function set text(param1:String) : void
      {
         ...
         var_324 = param1;
         if(var_324.charAt(0) == "$" && var_324.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_324.slice(2,var_324.indexOf("}")),this);
            var_753 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_973,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_695,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_695,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_695,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
