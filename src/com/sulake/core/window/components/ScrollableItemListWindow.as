package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_892:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_350)
         {
            var_350 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_350)
            {
               var_350.addEventListener(WindowEvent.const_238,scrollBarEventProc);
               var_350.addEventListener(WindowEvent.const_215,scrollBarEventProc);
            }
         }
         return var_350;
      }
      ...
      override public function dispose() : void
      {
         if(var_350)
         {
            var_350.removeEventListener(WindowEvent.const_238,scrollBarEventProc);
            var_350.removeEventListener(WindowEvent.const_215,scrollBarEventProc);
            var_350 = null;
         }
         if(var_892)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_892)
         {
            var_892 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_892;
      }
