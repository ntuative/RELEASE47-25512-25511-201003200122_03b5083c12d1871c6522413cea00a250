package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1100:String = "increment";
      
      private static const const_494:String = "slider_bar";
      
      private static const const_1099:String = "decrement";
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_881 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_881 != null)
         {
            _loc1_ = findParentByName(var_881) as IScrollableWindow;
            if(_loc1_ == null && var_8 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_8).findChildByName(var_881) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1100)
            {
               if(var_22)
               {
                  var_599 = true;
            ...
            else if(param2.name == ScrollbarController.const_1099)
            {
               if(var_22)
               {
                  var_599 = true;
         ...
         if(param1.type == WindowMouseEvent.const_947)
         {
