package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1125:String = "_HEADER";
      
      private static const const_781:String = "margin_right";
      
      private static const const_1126:String = "_SCALER";
      
      private static const const_1102:String = "_TITLE";
      
      private static const const_1124:String = "_CONTENT";
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_782,_loc3_.left,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_780,_loc3_.top,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_781,0 - _loc3_.right,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_783,0 - _loc3_.bottom,PropertyStruct.const_61,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1359 == null)
         {
            var_1359 = findChildByTag(const_1125) as IHeaderWindow;
            if(!var_1359)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1102) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return content != null && var_1386 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_21 == null)
         {
            var_21 = findChildByTag(const_1124) as IWindowContainer;
            if(!var_21)
            {
