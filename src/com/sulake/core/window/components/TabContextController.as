package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1111:String = "content";
      ...
      public function get container() : IWindowContainer
      {
         if(var_1601 == null)
         {
            var_1601 = findChildByTag(TabContextController.const_1111) as IWindowContainer;
         }
         return var_1601;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_937 == null)
         {
            var_937 = findChildByTag(TabContextController.const_1110) as ITabSelectorWindow;
            if(var_937 != null)
            {
