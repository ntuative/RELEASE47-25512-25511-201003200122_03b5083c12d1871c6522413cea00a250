package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_953:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_541:uint = 0;
      
      public static const const_898:String = "AssetLibraryReady";
      
      public static const const_1291:String = "AssetLibraryUnloaded";
      ...
      private var var_455:Boolean = true;
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_650)
         {
            delete var_650[_loc1_];
         }
         if(var_18 != null)
         {
            var_18.dispose();
         ...
         var_293 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1291));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_456 = _loc2_.manifest.copy();
         var_330 = _loc2_.resource;
         if(var_455)
         {
            AssetLibrary.fetchLibraryContents(this,var_456,var_330);
         }
         var_293 = true;
         dispatchEvent(new Event(AssetLibrary.const_362));
         dispatchEvent(new Event(AssetLibrary.const_898));
         if(var_455)
         {
            var_18.dispose();
            var_18 = null;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_953.splice(var_953.indexOf(this),1);
            --var_541;
            var_380 = null;
            var_650 = null;
            _loadedAssets = null;
      ...
      {
         var _loc2_:Class = var_650[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_456.child("library");
         if(_loc2_ == null)
         {
