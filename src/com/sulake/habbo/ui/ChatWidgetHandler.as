package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc12_ = uint(var_676.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
      ...
      {
         return [RoomWidgetChatMessage.const_673,RoomWidgetChatSelectAvatarMessage.const_727];
      }
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_137,_container.roomSession,0,"Version 25512-25511-201003200045");
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_814 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_814);
            }
            if(var_469 == null)
            {
               var_467.x = 0;
               var_467.y = 0;
               var_467.z = 0;
               var_469 = _loc4_.getScreenPoint(var_467);
               var_814 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_467.x = 0;
