package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_30:
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_282);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1015);
            ...
            case RoomObjectCategoryEnum.const_36:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_417)
               {
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_705);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_227)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_617);
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_832;
                  }
                  if(!_loc27_)
                  {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_331);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_538);
         _loc1_.push(RoomWidgetFurniActionMessage.const_684);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_720);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_569);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_514);
         _loc1_.push(RoomWidgetPetCommandMessage.const_663);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_331:
            ...
            case RoomWidgetUserActionMessage.const_611:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_824,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_548:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_538:
            ...
            case RoomWidgetFurniActionMessage.const_245:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_684:
            ...
            case RoomWidgetUserActionMessage.const_384:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_720:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_569:
