package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1594:IWindowContainer;
      
      public static var var_1369:IWindowContainer;
      
      public static var var_2258:int = 6710886;
      ...
      private var var_1387:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         if(var_1369 == null)
         {
            ...
            var_1369 = var_12.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1594 == null)
         {
            _loc5_ = var_12.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1594 = var_12.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
         var_327 = new Timer(1000);
         var_327.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_445)
         {
            ...
            var_445 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_445.procedure = stripClubDialogEventProc;
            var_445.center();
         }
         else
         {
            var_445.visible = true;
            var_445.center();
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1387 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_656 != null)
         {
            toggleCategoryView(var_656,true);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_327.stop();
            var_327.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_327 = null;
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_656 = param1;
         var_1387.setSelected(var_1387.getSelectableByName(param1));
         _window.invalidate();
      }
