package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_2107:PartOffsetData;
      
      private var var_887:AvatarActionManager;
      ...
      private var var_2106:AvatarRenderManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_716 = param4;
         var_2107 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_887.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_887.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_417.append(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_887.getActionDefinition(param1);
      }
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_887.getDefaultActionType();
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_417.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_417.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_716)
         {
            case AvatarType.const_81:
               ...
               var_1535.add(new AvatarStructureDownload(var_174,_loc5_,var_417));
               break;
            case AvatarType.PET:
         }
      ...
      {
         var_887 = new AvatarActionManager(var_174,var_716);
      }
      ...
      {
         return var_2107.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_417.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_417.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_887.sortActions(param1);
      }
   }
}
