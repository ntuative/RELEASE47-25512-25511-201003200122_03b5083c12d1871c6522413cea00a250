package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_917:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_439)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_71.getParts(param1,(var_917 as AvatarImage).getFigure(),_loc6_,var_1331,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_71.getCanvas(var_192,var_1331);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1197[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_833 || _loc32_ == AvatarAction.const_581) && (_loc6_ == AvatarBodyPartType.const_315 || _loc6_ == AvatarBodyPartType.const_1161 || _loc6_ == AvatarBodyPartType.const_1379) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_192 == AvatarScaleType.const_53)
            {
               _loc30_.x += 67;
            }
            else
