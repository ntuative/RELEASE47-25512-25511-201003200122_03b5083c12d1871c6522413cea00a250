package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1398,var_1396,var_1394,_alphaMultiplier);
         var_963 = generatePaletteMapForGrayscale(var_1725,var_1723);
      }
      
      public function get reds() : Array
      {
         return var_963.getValue("reds") as Array;
      }
      ...
      {
         return var_963.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_963.getValue("greens") as Array;
      }
      ...
      {
         return var_963.getValue("alphas") as Array;
      }
