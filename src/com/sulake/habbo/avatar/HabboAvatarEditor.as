package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_550:AvatarEditorHandler;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_662.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1154)
         {
            ...
            var_463["null"] = new FigureData(this);
            var_463["null"] = new FigureData(this);
            _loc1_ = var_463["null"];
            _loc2_ = var_463["null"];
            _loc1_.loadAvatarData("hr-681-35.hd-209-7.ch-878-87.lg-281-70.sh-906-77.ea-1401-77.ha-1010-70.he-1601-62.fa-1204-62.ca-1809-62.wa-2007-62",FigureData.const_88);
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.FEMALE);
            var_15 = new Map();
            var_15.add(AvatarEditorCategory.const_974,new GenericModel(this));
            var_15.add(AvatarEditorCategory.const_46,new HeadModel(this));
            var_15.add(AvatarEditorCategory.const_315,new TorsoModel(this));
            var_15.add(AvatarEditorCategory.const_1209,new LegsModel(this));
            var_15.add(AvatarEditorCategory.const_921,new WardrobeModel(this));
            var_1154 = true;
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_550 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_962 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc14_.isSelectable && (_loc13_ || var_962 >= _loc14_.clubLevel))
               {
                  _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1594.clone() as IWindowContainer,param1,_loc14_);
                  _loc4_.push(_loc17_);
            ...
            if(_loc8_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc6_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1369.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc21_ = false;
               if(_loc5_.gender == FigureData.const_1352)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc5_.isSelectable && _loc21_ && (_loc16_ || var_962 >= _loc5_.clubLevel))
               {
                  _loc6_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1369.clone() as IWindowContainer,param1,_loc5_,_loc12_,_loc15_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_15.getValue(AvatarEditorCategory.const_921);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_662.getPalette(param1);
      }
      ...
      {
         var_662 = var_549.getFigureData(AvatarType.const_81);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_549 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_215 == null)
            {
               var_215 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_59,HabboWindowStyle.const_38,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_215.addChild(_view.window);
               var_215.center();
               var_215.visible = false;
            }
            var_215.visible = true;
         }
         _view.show();
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_962 = param3;
         var _loc4_:FigureData = var_463[param2];
         if(_loc4_ == null)
         {
            return;
         }
