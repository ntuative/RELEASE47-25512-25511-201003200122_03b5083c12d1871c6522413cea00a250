package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1633:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1634:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1545:IIssueBrowserView;
      
      private const const_1639:String = "closed_issues";
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_352.view.width = var_233.container.width;
         var_352.view.height = var_233.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1632:
               if(var_1545 == null)
               {
                  var_1545 = new MyIssuesView(issueManager,this,var_233.container);
               }
               return var_1545;
            case const_1633:
               if(var_1546 == null)
               {
                  var_1546 = new OpenIssuesView(issueManager,this,var_233.container);
               }
               return var_1546;
            case const_1634:
               if(var_1547 == null)
               {
                  var_1547 = new PickedIssuesView(issueManager,this,var_233.container);
               }
               return var_1547;
            default:
               return null;
