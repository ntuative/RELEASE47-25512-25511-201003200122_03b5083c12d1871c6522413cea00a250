package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1588:IMessageComposer;
      ...
      {
         var_848 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_849 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         _main.connection.send(var_1588);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_848.clone());
      ...
      {
         if(param1.type != WindowEvent.const_45 || param2 != var_54)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_849.clone());
         _loc4_.color = var_1233[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
