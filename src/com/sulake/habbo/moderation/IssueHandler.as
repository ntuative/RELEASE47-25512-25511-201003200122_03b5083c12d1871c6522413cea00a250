package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         var_390 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         var_970 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         ...
         if(false)
         {
            var_970.load(_loc4_,var_111.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_56.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_56,WindowTracker.const_927,_loc2_),_window,false,false,true);
      }
