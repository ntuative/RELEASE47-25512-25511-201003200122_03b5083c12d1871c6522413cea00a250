package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_905:String = "issue_bundle_open";
      
      public static const const_713:String = "issue_bundle_my";
      
      public static const const_816:String = "issue_bundle_picked";
      ...
      private var var_538:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_122 = new Map();
         var_777 = new Map();
         var_538 = new IssueBrowser(this,var_56.windowManager,var_56.assets);
         var_645 = [];
         var_778 = [];
         var_951 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_951.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
         ...
         for each(_loc4_ in var_122)
         {
            switch(param1)
            {
               case const_905:
                  ...
                  break;
               case const_713:
                  if(_loc4_.state == IssueMessageData.const_459 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_777.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_777.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1267)
         {
            var_151.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_122)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_777.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_777.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_156)
         {
            ...
            _loc8_ = var_778.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_951.remove(param1);
         var_951.add(param1,_loc3_);
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_459 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         var _loc2_:* = var_951.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_538 == null || !var_538.isOpen())
         {
            var_56.soundManager.playSound(HabboSoundTypesEnum.const_932);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_777.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_122.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_459 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
