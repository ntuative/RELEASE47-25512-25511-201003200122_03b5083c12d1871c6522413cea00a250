package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      {
         return EffectsModel(var_47.getValue(InventoryCategory.const_517));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_47.getValue(InventoryCategory.const_73));
      }
      ...
      {
         return AchievementsModel(var_47.getValue(InventoryCategory.const_299));
      }
      ...
      {
         return TradingModel(var_47.getValue(InventorySubCategory.const_262));
      }
      ...
      {
         return var_47.getValue(InventoryCategory.const_427) as MarketplaceModel;
      }
      ...
      {
         return BadgesModel(var_47.getValue(InventoryCategory.const_255));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_47.add(InventoryCategory.const_427,_loc3_);
