package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_502 = new Timer(const_1094,1);
         var_502.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_12.getSubCategoryViewId() == InventorySubCategory.const_262;
      }
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_709)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_502 != null)
            {
               var_502.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_502.stop();
               var_502 = null;
            }
            if(var_135 != null)
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_262:
               ...
               break;
            case InventorySubCategory.const_811:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_12.checkCategoryInitilization(InventoryCategory.const_427);
         ...
         if(param1 == InventoryCategory.const_73 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_43:
                  ...
                  break;
               case const_335:
                  var_12.toggleInventoryPage(InventoryCategory.const_152);
            }
         }
      }
      ...
      {
         if(var_862 && param1.type == RoomEngineObjectEvent.const_220)
         {
            var_12.showView();
            var_862 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_323 || _loc3_.category == FurniCategory.const_309 || _loc3_.category == FurniCategory.const_336)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_410 = new Map();
         var_410.add(const_42,new Array());
         var_410.add(const_43,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
