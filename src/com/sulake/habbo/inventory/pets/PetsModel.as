package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1208 && param1.type == RoomEngineObjectEvent.const_220)
         {
            var_12.showView();
            var_1208 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1208 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_36,RoomObjectTypeEnum.const_334,_loc3_.figure);
            var_12.closeView();
            return;
         }
      ...
      {
         if(var_1001.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
