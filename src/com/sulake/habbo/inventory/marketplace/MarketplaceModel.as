package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1505,var_1506);
         }
      }
      ...
      {
         if(param1 != var_2007 || param2 != var_2004)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_2002);
      }
      ...
      {
         if(var_12 != null && false && var_223 != null)
         {
            var_12.furniModel.removeLockFrom(var_223.id);
            var_223 = null;
         }
      }
