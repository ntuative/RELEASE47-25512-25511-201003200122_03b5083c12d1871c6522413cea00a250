package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_695[var_1015] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_306)
         {
            ...
            var_306 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_306.center();
            var_306.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1015;
         if(var_1015 < var_695.length)
         {
            _loc1_ = var_695[var_1015] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_695.length);
                  _loc2_.text = _loc6_;
               }
