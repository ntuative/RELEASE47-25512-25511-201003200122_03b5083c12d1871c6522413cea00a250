package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_663,param1);
      ...
      {
         var_1022.remove(param1);
         var_1022.add(param1,param2);
         if(param1 != var_698)
         {
            return;
         }
      ...
      {
         var _loc2_:Array = var_1022.getValue(var_698) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_384,var_698));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_514,var_698,var_1966 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = var_1022.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
            requestEnabledCommands(var_698);
         }
         else
         {
      ...
      private function createCommandWindow() : void
      {
         ...
         var_42.setParamFlag(WindowParam.const_87,true);
         var_42.context.getDesktopWindow().addEventListener(WindowEvent.const_45,onWindowDesktopResized);
