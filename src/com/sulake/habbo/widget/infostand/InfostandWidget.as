package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1425:String = "infostand_user_view";
      ...
      private const const_1636:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_922 = new InfoStandFurniView(this,const_1423);
         var_205 = new InfoStandUserView(this,const_1425);
         var_319 = new InfoStandPetView(this,const_1424);
         var_365 = new InfoStandBotView(this,const_1426);
         var_404 = new InfostandUserData();
         var_410 = new InfostandFurniData();
         var_1299 = new InfoStandPetData();
         var_142 = new Timer(const_1636);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_205.setTags(param1.tags,var_2244);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_225,onClose);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_243,onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_131,onUserBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_661,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_384,var_319.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_225,onClose);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_243,onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_131,onUserBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_661,onBadgeImage);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_116:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_243:
