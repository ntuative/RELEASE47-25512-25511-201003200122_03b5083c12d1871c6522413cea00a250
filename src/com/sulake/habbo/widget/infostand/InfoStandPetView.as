package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1631:uint = 6710886;
      ...
      private const const_1630:int = 158;
      
      private const const_1628:int = 16;
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1299.getValue(var_698) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1630,const_1628,false);
         ...
         _loc5_.fillRect(_loc7_,const_1631);
         return _loc5_;
      }
