      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_904);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_959));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_697);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_802));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_254);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_559));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_568);
               break;
            case "news":
               if(false && false)
               {
