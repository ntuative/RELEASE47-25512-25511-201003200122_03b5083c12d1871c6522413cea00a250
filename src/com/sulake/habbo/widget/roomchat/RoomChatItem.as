package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_349:int = 10;
      ...
      {
         _widget.onItemMouseOut(var_1073,var_1072,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1073,var_727,var_1072,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1320 = param1.chatType;
         var_1073 = param1.userId;
         var_727 = param1.userName;
         var_1072 = param1.userCategory;
         _message = param1.text;
         var_1321 = param1.userX;
      ...
      public function method_9(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
      ...
      public function renderView() : void
      {
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_349;
            }
            else
            {
               _loc19_.text = var_727 + ":";
               _loc19_.y += var_427;
               _loc19_.width = _loc19_.textWidth + const_349;
               _width += _loc19_.textWidth + const_349;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1320 == RoomWidgetChatUpdateEvent.const_276)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_727);
            }
            else if(var_1320 == RoomWidgetChatUpdateEvent.const_239)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_727);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_349 + _loc20_.textWidth + const_495;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1073,var_1072,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1073,var_1072,_roomId,_roomCategory,param1);
      }
