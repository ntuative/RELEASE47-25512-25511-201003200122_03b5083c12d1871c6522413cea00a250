package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_59,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1092,const_1093,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            var_363 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_363 != null)
         {
            var_363.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(var_363 != null)
         {
            var_363.setValue(var_1086);
         }
         var_376 = colors.indexOf(_loc2_.color);
         if(var_523 != null)
         {
            var_523.setSelectedColorIndex(var_376);
         }
