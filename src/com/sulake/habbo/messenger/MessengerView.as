package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private function sendMsg() : void
      {
         ...
         var _loc2_:Conversation = var_124.method_1.findSelectedConversation();
         if(_loc2_ == null)
         {
         ...
         var_669.text = "";
         var_124.method_1.addMessageAndUpdateView(new Message(Message.const_670,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      public function refresh(param1:Boolean) : void
      {
         ...
         var_858.refresh();
         var_1249.refresh();
         if(var_124.method_1.openConversations.length < 1)
         {
            var_14.visible = false;
      ...
      public function openMessenger() : void
      {
         ...
         if(var_14 == null)
         {
            prepareContent();
            refresh(true);
            var_124.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MESSENGER,var_14));
         }
         else
         {
            refresh(true);
      ...
      private function prepareContent() : void
      {
         ...
         var_858 = new ConversationsTabView(var_124,var_14);
         var_858.refresh();
         var_669 = ITextFieldWindow(var_14.findChildByName("message_input"));
         var_669.addEventListener(WindowKeyboardEvent.const_146,onMessageInput);
         var_1249 = new ConversationView(var_124,var_14);
         var_14.scaler.setParamFlag(HabboWindowParam.const_651,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_913,true);
      }
   }
}
