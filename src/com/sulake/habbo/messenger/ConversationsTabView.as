package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         ...
         var_812 = IWindowContainer(param2.findChildByName("conversationstab"));
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:Array = var_124.method_1.openConversations;
         var _loc2_:int = 0;
         while(_loc2_ < getTabCount())
         {
            refreshTabContent(_loc2_,_loc1_[var_124.method_1.startIndex + _loc2_]);
            _loc2_++;
         }
         while(true)
         {
      ...
      {
         return var_124.method_1.startIndex > 0;
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            var_124.method_1.changeStartIndex(-1);
         }
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_165 ? var_124.method_1.findConversation(param2.id) : var_124.method_1.openConversations[_loc3_ + var_124.method_1.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
            var_124.method_1.setSelected(_loc4_);
         }
      ...
      {
         return var_124.method_1.openConversations.length - var_124.method_1.startIndex > getTabCount();
      }
      ...
      {
         var _loc3_:IWindowContainer = var_812.getChildAt(param1) as IWindowContainer;
         hideChildren(_loc3_);
