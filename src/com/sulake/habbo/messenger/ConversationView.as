package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1119:int = 20;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_124 = param1;
         var_1578 = initButton("follow_friend",onFollowButtonClick,param2);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_670 || param3.type == Message.const_591 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_519.messages.length - const_775);
         _loc1_ = 0;
      ...
      {
         var _loc1_:Conversation = var_124.method_1.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_775 + const_1119)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_124.method_1.closeConversation();
