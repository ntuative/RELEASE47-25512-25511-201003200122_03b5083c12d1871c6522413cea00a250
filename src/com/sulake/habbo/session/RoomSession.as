package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_957:UserDataManager;
      ...
      {
         if(var_36 == RoomSessionEvent.const_316 && _connection != null)
         {
            var_36 = RoomSessionEvent.const_96;
            if(isPrivateRoom)
            {
      ...
      {
         return var_957 as IUserDataManager;
      }
