package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1097:int = 3;
      
      private const const_1619:int = 2;
      
      private var var_874:AvatarVisualizationData = null;
      
      private const const_1098:int = 3;
      ...
      {
         var_874 = param1 as AvatarVisualizationData;
         createSprites(const_1098);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_423.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc14_:Number = _loc8_ - var_1273;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_325);
         if(_loc16_ > 0)
         {
         ...
         var _loc21_:Boolean = _isAnimating || var_506 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_506;
            ...
            if(var_570 != _loc7_)
            {
               for each(_loc49_ in var_423.getKeys())
               {
                  var_423.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_874.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_423.remove(_loc5_);
               var_423.add(_loc5_,_loc6_);
               var_570 = _loc7_;
            }
            ...
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_247) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_247);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_624);
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_376);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_53)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_482);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_311,AvatarAction.const_1369[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_835);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_880,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_794);
            if(_loc31_ > 0)
            {
               ...
               {
                  _loc6_.appendAction(AvatarAction.const_788,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_705);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_524);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_942,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_862);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_934,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_435);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_447) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_500);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_418);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_823);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_507,_loc36_);
            }
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_795))
            {
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_874.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
      ...
      override public function dispose() : void
      {
         ...
         if(var_423 != null)
         {
            _loc1_ = var_423.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_423.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
