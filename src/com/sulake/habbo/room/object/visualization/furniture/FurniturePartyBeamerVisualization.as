package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_975[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_977[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_975 = new Array();
         var_975.push(Math.random() * _loc2_ * 1.5);
         var_975.push(Math.random() * _loc2_ * 1.5);
         var_978 = new Array();
         var_978.push(1);
         var_978.push(-1);
         var_976 = new Array();
         var_976.push(const_1060);
         var_976.push(const_1061);
         var_977 = new Array();
         var_977.push(getRandomAmplitudeFactor());
         var_977.push(getRandomAmplitudeFactor());
      }
