package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_1405:String = null;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1405 != null && var_1405.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
      ...
      {
         var _loc3_:int = 0;
         if(var_1868 != param1 || var_1867 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_1866 != param1 || var_1865 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2270 = _loc3_.getNumber(RoomObjectVariableEnum.const_222);
            ...
            var_1405 = _loc3_.getString(RoomObjectVariableEnum.const_317);
