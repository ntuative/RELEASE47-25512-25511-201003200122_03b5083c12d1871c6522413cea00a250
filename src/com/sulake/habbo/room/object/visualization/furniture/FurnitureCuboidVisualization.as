   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         while(_loc5_ < var_105.length)
         {
            ...
            _loc9_ = var_105[_loc5_] as FurniturePlane;
            if(_loc9_ != null)
            {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + var_1453;
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_521);
