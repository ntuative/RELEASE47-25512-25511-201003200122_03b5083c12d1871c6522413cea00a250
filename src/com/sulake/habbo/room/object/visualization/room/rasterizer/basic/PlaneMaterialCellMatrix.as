package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1138:int = const_291;
      ...
      private var var_1313:Boolean = true;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1559 == const_104)
         {
            _loc5_ = new Rectangle(0,0,var_25.width,var_355);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_355,var_25.width,var_355);
         }
