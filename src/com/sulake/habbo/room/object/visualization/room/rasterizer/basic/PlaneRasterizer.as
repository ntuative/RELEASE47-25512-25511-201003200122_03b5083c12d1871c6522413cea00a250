package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_736:String = "default";
      ...
      {
         return var_301.getValue(param1) as PlaneMaterial;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_105 != null)
         {
            ...
            {
               _loc2_ = var_105.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function resetMaterials() : void
      {
         ...
         {
            _loc2_ = var_301.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return var_105.getValue(param1);
      }
      ...
      public function clearCache() : void
      {
         ...
         while(_loc1_ < var_301.length)
         {
            _loc3_ = var_301.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
