package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1321:int = 13421772;
      
      private static const const_1130:int = 16777215;
      
      public static const const_1206:int = 10066329;
      ...
      public static const const_1362:int = 16777215;
      ...
      private var var_1178:String = null;
      
      private var var_2246:int = 255;
      ...
      private var var_615:Rectangle = null;
      
      private var var_2248:int = 255;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_938);
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < var_105.length)
            {
               _loc4_ = var_105[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_615 == null)
         {
            var_615 = super.boundingRectangle;
         }
         return new Rectangle(var_615.x,var_615.y,var_615.width,var_615.height);
      }
         ...
         while(_loc5_ < var_436.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_105.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_235 || _loc3_.type == RoomPlane.const_189 && _loc8_ == RoomPlaneBitmapMaskData.const_208)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1453;
                        if(var_79.getPlaneType(_loc9_) == RoomPlaneData.const_139)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1216)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_1010 || _loc9_.y != var_1887 || _loc9_.z != var_1890 || param1.scale != var_1889))
            {
               var_1010 = _loc9_.x;
               var_1887 = _loc9_.y;
               var_1890 = _loc9_.z;
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_935);
            if(_loc10_ != var_2245)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_698));
            if(_loc11_ != var_1090)
            {
               var_1090 = _loc11_;
               var_2249 = var_1090 & 255;
               var_2248 = var_1090 >> 8 & 255;
               var_2246 = var_1090 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_2014 + const_1637 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_2014 = _loc7_;
         if(var_160 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_669);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_731);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_660);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_2247 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_982));
            var_160 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_437.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_437[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_189)
            {
               if(var_2247)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_2249 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_2248 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_2246 / 255);
