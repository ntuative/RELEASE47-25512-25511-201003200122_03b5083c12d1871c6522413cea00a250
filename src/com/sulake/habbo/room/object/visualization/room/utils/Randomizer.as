package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1473:int = 16777216;
      ...
      private var var_1422:int = 16777216;
      ...
      public static function getArray(param1:int, param2:int) : Array
      {
         ...
         return _randomizer.method_10(param1,param2);
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1422 * param2);
      }
      
      public function method_10(param1:int, param2:int) : Array
      {
         var _loc7_:int = 0;
      ...
      {
         var _loc1_:int = var_2340 * var_1147 + var_2341;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
