package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_632:
                  _loc2_.setString(RoomObjectVariableEnum.const_731,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_587:
                  _loc2_.setString(RoomObjectVariableEnum.const_669,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_502:
                  _loc2_.setString(RoomObjectVariableEnum.const_660,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_935,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_982,int(_loc5_.bgOnly));
            var_1133 = _color;
            var_1406 = var_1238;
            var_950 = _loc11_;
            var_1407 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_938,param1.toString(),true);
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc7_.x >= 0 && _loc7_.x < _loc14_ && _loc7_.y >= 0 && _loc7_.y < _loc15_)
         {
            ...
            _loc4_.setNumber(RoomObjectVariableEnum.const_1212,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1221,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_157 || _loc13_ == RoomPlaneData.const_236)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_772)
         {
            ...
            {
               _loc7_ = var_1133 >> 16 & 255;
               _loc8_ = var_1133 >> 8 & 255;
               _loc9_ = var_1133 & 255;
               _loc10_ = var_950 >> 16 & 255;
               _loc11_ = var_950 >> 8 & 255;
               _loc12_ = var_950 & 255;
               _loc13_ = (_loc2_ - var_772) / var_1408;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1406 + (var_1407 - var_1406) * _loc13_;
               _color = _loc3_;
               var_1238 = _loc4_;
            }
