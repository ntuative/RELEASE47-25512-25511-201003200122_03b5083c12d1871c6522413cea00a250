         ...
         if(object != null)
         {
            ...
            if(object.getType() == "pet")
            {
               ...
               if(param1 is RoomObjectAvatarFigureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_1231,_loc4_.race);
               }
               ...
               if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_482,new Date().valueOf());
               }
               ...
               if(param1 is RoomObjectAvatarPostureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_247,_loc10_.postureType);
               }
               ...
               if(param1 is RoomObjectAvatarExperienceUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_907,Number(getTimer()));
                  _loc2_.setNumber(RoomObjectVariableEnum.const_850,Number(_loc12_.gainedExperience));
               }
            }
         }
      }
