package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_1039:String = "tile_cursor";
      ...
      private var var_539:NumberBank;
      ...
      private var var_647:RoomMessageHandler = null;
      
      private var var_646:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_292 = new Map();
         var_539 = new NumberBank(1000);
         var_952 = new Map();
         var_291 = new Map();
         var_65 = new RoomObjectEventHandler(this);
         var_647 = new RoomMessageHandler(this);
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_570) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_528) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_639) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_728) + 0.5;
      ...
      override public function dispose() : void
      {
         ...
         if(var_425 != null)
         {
            var_425.release(new IIDRoomObjectVisualizationFactory());
            var_425 = null;
         }
         if(var_41 != null)
         {
         ...
         if(var_646 != null)
         {
            var_646.release(new IIDRoomRendererFactory());
            var_646 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_646.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_839;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_541);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_526);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_533);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_844);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1012);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_993) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1009);
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_540,var_109,var_108,param2,param3));
            }
         }
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_632,param3);
         ...
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_502,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_282,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_317,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_831,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1015,param10);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_258,param1,param2,param3,RoomObjectCategoryEnum.const_31));
         }
         var _loc15_:ISelectedRoomObjectData = method_2(param1,param2);
      ...
      {
         if(var_28 == null || var_425 == null || var_41 == null || var_646 == null || _communication == null || _habboConfiguration == null || !var_1679)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_280,RoomObjectCategoryEnum.const_60);
      }
      ...
      public function addObjectFurnitureByName(param1:int, param2:int, param3:int, param4:String, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN) : Boolean
      {
         ...
         var _loc12_:ISelectedRoomObjectData = method_2(param1,param2);
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1253,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_749,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_108,var_1136);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_108,var_1136);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_425 = param2 as IRoomObjectVisualizationFactory;
         if(var_11 != null)
         {
            var_11.visualizationFactory = var_425;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_28 != null)
         {
            if(false)
            {
               var_28.events.addEventListener(RoomObjectMouseEvent.const_201,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.const_353,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_725,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_95,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_398,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_481,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_372,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_442,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_443,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_478,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_63,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMoveEvent.const_410,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMoveEvent.const_351,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_269,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_355,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_312,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_283,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_466,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_830,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_441,roomObjectEventHandler);
               var_28.events.addEventListener(AvatarWalkWarpingWarningEvent.const_458,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_707) != 0)
         {
            return false;
         }
         if(var_65 != null)
      ...
      public function method_2(param1:int, param2:int) : ISelectedRoomObjectData
      {
         var _loc3_:RoomInstanceData = getRoomInstanceData(param1,param2);
         if(_loc3_ != null)
         {
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_453 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_558,0,0));
            _loc2_ = 0;
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_258,param1,param2,param3,RoomObjectCategoryEnum.const_36));
         }
         return true;
      }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_664)
         {
            var_1679 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_282,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_317,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_839,1,true);
         }
         ...
         var _loc13_:ISelectedRoomObjectData = method_2(param1,param2);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_260.events.addEventListener(AdEvent.const_407,showRoomAd);
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_646 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = var_41.getRoom(const_491);
         if(_loc10_ == null)
         {
            _loc10_ = var_41.createRoom(const_491,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_539.reserveNumber();
            ...
            case RoomObjectCategoryEnum.const_60:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_731,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_669,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_660,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
         ...
         {
            var_952.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_869,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_539.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1415 - _loc12_.width / 2;
               _loc11_.y = var_1414 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_438,var_109,var_108,-1,RoomObjectCategoryEnum.const_213));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_65 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_280,const_490);
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_108,var_1136);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1415 - _loc6_.data.width / 2;
               _loc11_.y = var_1414 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_11 != null)
         {
            ...
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_337,param1.image,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_878,param1.adWarningL,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_922,param1.method_11,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_799,RoomObjectVariableEnum.const_337,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_11 != null)
         {
            _events.addEventListener(RoomContentLoader.const_664,onContentLoaderReady);
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_41.getRoom(const_491);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_869);
               ...
               var_539.freeNumber(_loc10_ - 1);
               _loc13_ = var_952.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_109,var_108,const_280,RoomObjectCategoryEnum.const_60,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_707,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_996,_loc13_,true);
            if(var_11 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_280,const_490,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_707,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_541,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_570,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_639,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_528,_loc18_);
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_632,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
         ...
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_502,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_468,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_208);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_526,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_533,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_526,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_533,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_844,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1012,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_750,const_1039,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         _loc7_.createRoomObject(const_749,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         return _loc7_;
      }
