package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1421,this._model.mode != ThumbnailEditorModel.const_55);
         setEnabled(var_1420,this._model.mode != ThumbnailEditorModel.const_34);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1421 = IButtonWindow(find("top_tab"));
         var_1420 = IButtonWindow(find("obj_tab"));
         var_1700 = IWindowContainer(find("tile_grid"));
         var_1701 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1421,onTopTabButton);
         Util.setProcDirectly(var_1420,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1700;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_391)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1701;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_59,HabboWindowStyle.const_38,HabboWindowParam.const_70,new Rectangle(0,0,param1.width,66)));
