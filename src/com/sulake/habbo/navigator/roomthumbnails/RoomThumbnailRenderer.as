package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1107:int = -16;
      
      private static const const_765:int = 32;
      
      private static const const_1105:int = 8;
      
      public static const const_391:int = 10;
      ...
      private var var_897:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_897 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_897.getImage(ThumbnailEditorModel.const_34,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1107,_loc4_.y + const_1106 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2125[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_897.getImage(ThumbnailEditorModel.const_37,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_897.getImage(ThumbnailEditorModel.const_37,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_897.getImage(ThumbnailEditorModel.const_55,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_765 + _loc3_,param2 * const_1105);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1301 == null)
         {
            var_1301 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1301,var_1301.rect,new Point(0,0),null,null,true);
      }
   }
}
