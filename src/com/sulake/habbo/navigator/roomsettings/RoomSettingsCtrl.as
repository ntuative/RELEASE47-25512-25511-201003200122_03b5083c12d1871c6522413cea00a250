package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1191:TextFieldManager;
      ...
      private function populateForm() : void
      {
         ...
         var_1196.setText(_loc1_.description);
         var_989.setText("");
         var_1191.setText("");
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_178,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_59,HabboWindowStyle.const_38,HabboWindowParam.const_70,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1824.visible = var_475;
         var_1823.visible = !var_475;
         if(var_475)
         {
            var_988.visible = true;
            var_1192.visible = false;
            refreshFlatControllers();
            var_988.height = Util.getLowestPoint(this.var_988) + 4;
         }
         else
         {
            populateForm();
            var_992.visible = true;
            ...
            var_992.height = Util.getLowestPoint(this.var_992) + 4;
         }
         var_1449.text = !!var_475 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1451.name,var_1197.name,var_992.name,var_988.name,var_1192.name,var_1448.name],0,0);
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = var_1196.getText();
         ...
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_124)
         {
            ...
            _loc9_ = var_1191.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_989.clearErrors();
               this.var_1191.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = var_1195.isSelected;
         _loc2_.allowFoodConsume = var_1194.isSelected;
         _loc2_.allowWalkThrough = var_1193.isSelected;
         _loc2_.tags = new Array();
         addTag(var_801,_loc2_.tags);
         addTag(var_803,_loc2_.tags);
         this.clearErrors();
         this.var_990 = _loc2_.roomId;
      ...
      {
         if(param1 != this.var_396 || var_990 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_990 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1222)
         {
         ...
         {
            this.var_1196.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1170)
         {
            setTagError(this.var_801,param3,"${navigator.roomsettings.unacceptablewords}");
         ...
         {
            setTagError(this.var_801,param3,"${navigator.roomsettings.nonuserchoosabletag}");
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_887,onDoorModePasswordUnselect);
         ...
         this.var_1196 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_801 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         ...
         this.var_1191 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1195 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1194 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1193 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         ...
         var_992 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_988 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1448 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1192 = IWindowContainer(_window.findChildByName("footer_container"));
         ...
         var_1824 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1449 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1449.procedure = onSwitchView;
         var_991.visible = false;
         if(!_inRoom)
         {
