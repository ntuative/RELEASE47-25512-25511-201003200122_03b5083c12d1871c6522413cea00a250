package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var include:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_524 = new Timer(100);
         var_524.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_44 = new Array();
         ...
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_151,80,"g"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_151,74,"h"));
         ...
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_151,416,"o"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_151,352,"p"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_151,304,"q"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_151,336,"r"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_148,0,"s"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_148,0,"t"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_148,0,"u"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_148,0,"v"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_148,0,"w"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_148,0,"x"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_1089 = new TextFieldManager(_navigator,ITextFieldWindow(var_21.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function addThumbnail(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
         ...
         if(param2.requiredClubLevel == HabboClubLevelEnum.const_151)
         {
            _loc8_ = "hc_only";
         }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1089.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1976 = _navigator.data.hcMember;
      }
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         switch(param1.requiredClubLevel)
         {
            case HabboClubLevelEnum.const_75:
               return true;
            case HabboClubLevelEnum.const_151:
      ...
      public function dispose() : void
      {
         if(var_524)
         {
            var_524.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_524.reset();
            var_524 = null;
         }
      }
      ...
      {
         var_1089.goBackToInitialState();
         var_1089.input.textBackgroundColor = 4294967295;
         include = var_44[0];
         if(var_1976 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_59,HabboWindowStyle.const_38,HabboWindowParam.const_70,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_1089.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(include.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1353 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1353 = true;
            _loc3_.y = 1;
