package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1205:ProfilerAgentTask;
      
      private var var_1202:IEventDispatcher;
      
      private var var_2359:uint = 0;
      
      private var var_1204:ProfilerAgentTask;
      
      private var var_1203:ProfilerOutput;
      
      private var var_686:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1202 = Component(param1).events;
         var_398 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_686 = new WindowRenderer(_loc4_);
         var_219 = new Array(const_343);
         var _loc6_:int = 0;
         while(_loc6_ < const_343)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_686,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_219[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_215 = var_219[const_1078];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_215.getMouseCursor().defineCustomCursorType(MouseCursorType.const_332,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_215.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1140,_loc7_);
      }
      ...
      {
         return var_219[param1].getDesktopWindow().getChildAt(var_215.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1203 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1203 = new ProfilerOutput(_loc3_,this,var_686);
               var_1205 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1205);
               var_1204 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1204);
               var_1000 = true;
            }
         }
      }
      ...
      {
         return var_215.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1202.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_343 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1202.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         var_1202.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      {
         return var_215.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1223,param2.name + ": " + param2.toString());
            }
