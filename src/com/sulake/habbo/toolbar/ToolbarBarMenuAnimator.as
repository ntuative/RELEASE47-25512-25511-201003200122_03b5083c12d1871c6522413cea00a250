package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1033:Number = 90;
      
      private static const const_757:int = 50;
      
      private static const const_1035:Number = 25;
      ...
      private var var_981:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_981 = param2;
         var_558 = new Timer(const_1035);
         var_558.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var_470.push(param2);
         param1.addEventListener(WindowEvent.const_404,windowEventListener);
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_981.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_981.getIconLoc(param1.iconId);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_559[_loc3_] = new Array();
            }
            if(var_559[_loc3_].indexOf(param1) < 0)
            {
               var_559[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_757 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_757 || param1.desktop.height - param1.y < const_1065;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < var_471.length)
         {
            if(var_471[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_559[_loc3_].length)
                  {
                     repositionWindow(var_559[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
