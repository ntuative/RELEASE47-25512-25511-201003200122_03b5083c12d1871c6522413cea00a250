package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_196 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_59,HabboWindowStyle.const_908,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1033 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1033)
         {
         ...
         var_1258 = _loc7_.toolbar.@margin_bottom;
         var_1508 = _loc7_.toolbar.@min_group_margin;
         var_1509 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_268,param1,param2,_window,var_245);
         createGroupsFromXmlList(_loc9_,var_588,param1,param2,var_196,var_245);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_134,var_501,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1508,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1258) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1508,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1258) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_588.length)
         {
            _loc3_ = var_588[_loc2_];
            if(_loc3_ != null)
            {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_134,var_501);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_588.length)
         {
            _loc2_ = var_588[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_501);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_134,var_501);
         }
      }
