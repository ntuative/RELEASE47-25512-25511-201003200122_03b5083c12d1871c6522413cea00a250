   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1205,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1356,Capabilities.serverString);
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_679:
               trackLoginStep(HabboLoginTrackingStep.const_1133,String(_communication.port));
               break;
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_294:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_156)
         {
            Component(var_156).events.addEventListener(HabboConfigurationEvent.const_181,onConfigurationLoaded);
            if(var_228 != null)
            {
               var_228.configuration = var_156;
            }
            if(var_227 != null)
            {
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_260.events.addEventListener(AdEvent.const_407,onRoomAdLoad);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_582,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_64,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_462,onHotelViewEvent);
      }
         ...
         if(!disposed)
         {
            ...
            if(var_173)
            {
               if(true)
               {
                  ...
                  Component(var_173).events.removeEventListener(HabboFriendListTrackingEvent.const_294,onFriendlistTrackingEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_156)
         {
            Component(var_156).events.removeEventListener(HabboConfigurationEvent.const_181,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_963);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_963,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++var_1521;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1521);
         }
         if(var_1038 > -1 && _loc2_ - var_1038 > 15000)
         {
            ++var_1520;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1520);
         }
         var_1038 = _loc2_;
         if(var_227 != null)
         {
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_173).events.addEventListener(HabboFriendListTrackingEvent.const_294,onFriendlistTrackingEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_582)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1248);
         }
         else if(param1.type == HabboHotelViewEvent.const_462)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1233);
         }
