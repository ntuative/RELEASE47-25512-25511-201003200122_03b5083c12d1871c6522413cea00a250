package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1285 || var_1497 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1496 == 0 || _loc1_ - var_1496 > var_1497)
         {
            if(_connection != null)
            {
      ...
      {
         var_1285 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1497 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
