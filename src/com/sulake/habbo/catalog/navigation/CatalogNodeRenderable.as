package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1477:XML;
      
      private static var var_1478:XML;
       
      
      private var var_2299:IWindowContainer;
      ...
      private var var_1476:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1477 == null)
         {
            ...
            var_1477 = _loc4_.content as XML;
         }
         if(var_1478 == null)
         {
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1476 == 4294967295)
            {
               var_1476 = _loc1_.color;
            }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1477) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_50 = navigator.catalog.windowManager.buildFromXML(var_1478) as IItemListWindow;
         if(var_50 == null)
         {
