package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_575[var_1016] as Array;
      ...
      {
         var _loc2_:Offer = var_575[var_1016][var_1915];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_434 || _loc1_.pricingModel == Offer.const_422)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_79 || _loc3_.productType == ProductTypeEnum.const_82)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_1017.indexOf(_loc5_) == -1)
                        {
                           var_1017.push(_loc5_);
                           var_575.push(new Array());
                        }
                        _loc6_ = var_1017.indexOf(_loc5_);
                        (var_575[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_575)
         {
            if(var_1915 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1915] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1016 = var_928.getGridItemIndex(param1.view);
