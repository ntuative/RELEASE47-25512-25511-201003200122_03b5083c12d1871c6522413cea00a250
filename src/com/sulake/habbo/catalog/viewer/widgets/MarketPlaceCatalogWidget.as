package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_789:MarketPlaceOfferData;
      ...
      private const const_1397:int = 2;
      ...
      private function updateList() : void
      {
         ...
         updateStatusDisplay(const_1397,_loc2_.length);
         if(!var_382)
         {
            var_382 = new Timer(25);
            var_382.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_790 = 0;
         populateList();
         var_382.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_542)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1396);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_383.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_382)
         {
            var_382.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_382 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_790 >= var_542.length)
            {
               return true;
            }
            addListItem(var_542.getWithIndex(var_790));
            ++var_790;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_789.offerId);
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_383));
            _loc7_.selection = 0;
         }
      }
