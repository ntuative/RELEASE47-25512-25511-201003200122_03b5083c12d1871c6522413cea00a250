package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_905:PrizeViewer;
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_726[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_905 = new PrizeViewer();
         var_542 = new Map();
         var_726 = recycler.getPrizeTable();
         if(var_726 == null)
         {
            return;
         }
         ...
         var_2156 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_726[0].prizes.length > 0)
         {
            select(var_726[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_2156) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_905.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
