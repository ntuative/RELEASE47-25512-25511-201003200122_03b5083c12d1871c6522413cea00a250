package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1211:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1189.text = "${" + _loc3_.name + "}";
            var_1188.text = "${" + _loc3_.description + "}";
         }
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_450:
                  ...
                  if(var_568 != null)
                  {
                     ...
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_568,var_1211,var_1371);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_212:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_311,AvatarAction.const_503);
                              _loc13_.appendAction(AvatarAction.const_507,_loc6_.productClassId);
      ...
      {
         var_1189 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1188 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1462 = new Point(var_85.x,var_85.y);
         var_568 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1211 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_568 == null)
         {
         ...
         var_1212 = _loc2_.content as BitmapData;
