package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_376 >= var_289.length)
         {
            return "";
         }
         var petColor:IPetColor = var_289[var_376] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_533[var_1390] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_376 = param1.index;
         if(var_376 < 0 || var_376 > var_289.length)
         {
            var_376 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_542.getWithIndex(0),page,p);
      }
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_542.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_376 >= 0 && var_376 < var_289.length)
         {
            _loc7_ = var_289[var_376] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_533[var_1390] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_761,_loc3_.id,_loc2_,AvatarScaleType.const_53);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_311,AvatarAction.const_699);
