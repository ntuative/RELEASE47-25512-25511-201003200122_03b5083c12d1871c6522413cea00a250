package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1640:int = 3;
      
      public const const_1433:int = 2;
      ...
      private var var_185:MarketplaceConfirmationDialog;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1488,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_2007 || param1.furniTypeId != var_2004)
         {
            return;
         }
         var_2118 = param1;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1433,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_2119 = _loc3_.creditsWaiting;
         var_200 = new Map();
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_185)
         {
            var_185 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_185.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_2122,var_2120,var_1614,var_2121);
      }
