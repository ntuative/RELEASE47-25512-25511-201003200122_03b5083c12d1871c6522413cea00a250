package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_117.removeEventListener(SSOTicket.const_306,onParsedTicketSuccess);
         var_117.removeEventListener(SSOTicket.const_260,onParsedTicketFailure);
         var_117 = null;
      ...
      private function createWindow() : void
      {
         ...
         _window = var_364.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_479,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
      ...
      private function initSSOTicket() : void
      {
         ...
         var_117.addEventListener(SSOTicket.const_306,onParsedTicketSuccess);
         var_117.addEventListener(SSOTicket.const_260,onParsedTicketFailure);
      }
