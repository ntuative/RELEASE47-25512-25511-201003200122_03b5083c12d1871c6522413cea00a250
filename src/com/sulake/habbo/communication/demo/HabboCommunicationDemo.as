package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      public function HabboCommunicationDemo(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         queueInterface(new IIDHabboCommunicationManager(),method_7);
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1228:
            case DisconnectReasonEvent.const_1171:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1151:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1278:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2211)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_740 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_740);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1339,var_2210));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2212);
      ...
      {
         var_740 = _habboConfiguration.getKey("sso.ticket",null);
         var_1339 = _habboConfiguration.getKey("flash.client.url","");
         var_2210 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_178 == null)
         {
         ...
         if(var_740 != null)
         {
            var_66.mode = HabboConnectionType.const_360;
            var_66.initConnection(HabboConnectionType.const_249);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1583 = param2 as ILogger;
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2212 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_66.mode)
         {
            case HabboConnectionType.const_360:
               ...
               var_1080 = _loc4_;
               var_178.loadBannerImage(_loc7_ + "?token=" + var_1080,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_962:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1240:
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1080);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_66.mode = HabboConnectionType.const_962;
            }
         }
         var_66.initConnection(HabboConnectionType.const_249);
      }
