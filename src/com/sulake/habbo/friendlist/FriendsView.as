package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         var_1616 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1615 = initButton("room_invite",onInviteButtonClick,param1);
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1616,isEnableHomeButton(_loc1_));
         setEnabled(var_1615,isEnableInviteButton(_loc1_));
