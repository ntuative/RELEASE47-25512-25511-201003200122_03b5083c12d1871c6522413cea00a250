package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_689 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_689.procedure = onSearchInput;
         var_689.addEventListener(WindowKeyboardEvent.const_146,onSearchStrInput);
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_689.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
