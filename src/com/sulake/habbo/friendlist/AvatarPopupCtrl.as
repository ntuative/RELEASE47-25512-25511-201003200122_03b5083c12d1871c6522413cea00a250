package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1253 != "")
         {
            friendList.refreshText(param1,"name_text_online",var_690,var_1253);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",var_690,var_1461);
         }
         friendList.refreshText(param1,"name_text_offline",!var_690,var_1461);
         friendList.refreshText(param1,"motto_text",var_690,var_1874);
         friendList.refreshButton(param1,"offline",!var_690,null,0);
         if(var_690)
         {
            refreshFigure(param1,var_1873);
