package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1391:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_763:FriendRequests;
      
      private var var_1634:int;
      
      var var_15:FriendCategories;
      
      private var var_1633:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_764:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1633 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_15 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1391 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_763.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_763.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_412.findTab(FriendListTab.const_83).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_763 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         ...
         var_15.addCategory(new FriendCategory(FriendCategory.const_457,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_15.addFriend(new Friend(_loc4_));
         }
         var_412 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_449)
         {
            var_449 = new Timer(120000);
            var_449.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_449.start();
         }
         getBuddyRequests();
         registerListeners();
         var_182.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_132,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_449.stop();
            var_449.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_449 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_764)
         {
            var_764.release(new IIDHabboNotifications());
            var_764 = null;
         }
         if(var_182)
         {
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_412.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_294));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1391.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_763.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:FriendListTab = var_412.findTab(FriendListTab.const_83);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_765.createAvatarImage(param1,AvatarScaleType.const_102);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_763.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_412.findTab(FriendListTab.const_83);
      ...
      {
         var_764 = param2 as IHabboNotifications;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1392 == null)
         {
            var_1392 = new OpenedToWebPopup(this);
         }
         var_1392.show(x,y);
      }
