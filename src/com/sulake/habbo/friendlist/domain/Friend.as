package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1590:int = "F".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_1254 = param1.gender;
         var_690 = param1.online;
         var_1257 = param1.followingAllowed && param1.online;
         var_570 = param1.figure;
         var_1255 = param1.motto;
         var_1256 = param1.lastAccess;
         var_1166 = param1.categoryId;
         var_1253 = param1.realName;
