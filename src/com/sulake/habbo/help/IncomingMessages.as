package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_23.tellUI(HabboHelpViewEnum.const_205,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_23.tellUI(HabboHelpViewEnum.const_253,_loc6_);
      }
      ...
      {
         var_23.showUI(HabboHelpViewEnum.const_295);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_23.showUI(HabboHelpViewEnum.const_415);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_23.showUI(HabboHelpViewEnum.const_717);
         var_23.tellUI(HabboHelpViewEnum.const_717,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_417)
            {
         ...
         var_23.tellUI(HabboHelpViewEnum.const_553);
      }
