package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         _main = param1;
         _main.events.addEventListener(HabboHelpTutorialEvent.const_710,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_573,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_566,onTaskDoneEvent);
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_1061 = param2;
         var_1059 = param3;
         if(var_31 == null || var_31.id == const_89)
         {
            prepareForTutorial();
            showView(const_89);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_1061 = true;
         if(var_31 != null && (var_31.id == const_234 || var_31.id == const_89))
         {
            showView(const_89);
         }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1439;
         _window.width = _loc2_.width + var_1438;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_710:
               var_1059 = true;
               if(var_31 != null && var_31.id == const_394)
               {
                  showView(const_89);
               }
               break;
            case HabboHelpTutorialEvent.const_573:
               if(var_31 != null && var_31.id == const_304)
               {
                  var_1308 = true;
                  disposeWindow();
               }
      ...
      {
         var_1060 = true;
         if(var_31 != null && (var_31.id == const_304 || var_31.id == const_89))
         {
            showView(const_89);
         }
      }
      ...
      {
         return var_1060 && var_1061 && var_1059;
      }
   }
}
