package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1514:uint = 13232628;
      
      private static var var_2030:uint = 11129827;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_411);
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_411);
         }
         if(var_270 == null)
         {
            var_270 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_270 == null)
            {
               return;
            }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1593 || param1 == ChangeUserNameResultMessageEvent.var_1596)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_865 = new NameSuggestionListRenderer(_main);
         var _loc6_:int = var_865.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1514;
