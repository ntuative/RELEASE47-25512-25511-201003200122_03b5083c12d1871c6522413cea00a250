package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1765:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25512-25511-201003200045");
         var_182 = param5;
         var_98 = new Map();
         var_98.add(HabboHelpViewEnum.const_1308,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_147,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_415,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_253,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_205,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_717,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_295,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_523,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_230,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_98.add(HabboHelpViewEnum.const_793,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_98.add(HabboHelpViewEnum.const_553,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_256 == HabboHelpViewEnum.const_147 || false)
         {
            return;
         }
         if(var_392 == null)
         {
            ...
            var_392 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_392 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_392 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_392 as IWindow);
      ...
      {
         return var_98.getValue(var_256);
      }
      ...
      {
         var_1764 = param1;
         var _loc2_:IHelpViewController = var_98.getValue(HabboHelpViewEnum.const_147) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_230:
               showUI(HabboHelpViewEnum.const_230);
               break;
            case CallForHelpResultEnum.const_855:
               showUI(HabboHelpViewEnum.const_793);
               break;
            case CallForHelpResultEnum.const_944:
      ...
      {
         var _loc3_:* = null;
         if(var_256 == HabboHelpViewEnum.const_147)
         {
            return;
         }
         if(true)
         ...
         var _loc2_:IBitmapWrapperWindow = var_392.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1439;
         _window.width = _loc1_.width + var_1438;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_182 != null)
            {
               var_182.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_710));
      }
