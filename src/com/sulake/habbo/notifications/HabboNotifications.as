package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1075:String = "badges";
      
      private static const const_1069:String = "pet_inventory";
      
      private static const const_1076:String = "pixelbalance";
      
      private static const const_1074:String = "credits";
      
      private static const const_1073:String = "inventory";
      
      private static const const_1070:String = "friendlist";
      
      private static const const_1072:String = "selectfurni";
      ...
      private var var_562:ParkBusDialogManager;
      
      private var var_561:IHabboToolbar;
      ...
      private var var_684:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_825);
         }
         var _loc6_:Map = var_825["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1196);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_684 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_870)
         {
            return;
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1822)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_952);
            var_1822 = true;
      ...
      override public function dispose() : void
      {
         ...
         if(var_561)
         {
            var_561.release(new IIDHabboToolbar());
            var_561 = null;
         }
         if(_windowManager)
         {
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1069:
               if(var_10)
               {
                  var_10.toggleInventoryPage(InventoryCategory.const_152);
               }
               break;
            case const_1072:
               break;
      ...
      private function method_6(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_952,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_549.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_53);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1007,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_173 || param2.type == WindowEvent.const_560)
         {
            param1.dispose();
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_562 == null)
         {
            var_562 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_562 != null)
         {
            var_562.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_987.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_549.createPetImage(_loc2_.figure,AvatarScaleType.const_53);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.products.length > 0)
            {
               ...
               else if(_loc14_.productType == CatalogPageMessageProductData.const_79)
               {
         ...
         if(_loc8_)
         {
            addItem(_loc8_.value,NotificationType.const_1301,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_549.createAvatarImage(param2,AvatarScaleType.const_53);
         if(_loc7_ != null)
         {
      ...
      {
         var_561 = IHabboToolbar(param2);
         var_561.events.addEventListener(HabboToolbarEvent.const_84,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_338.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_826);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_826);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_84)
         {
            ...
            var_394 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_825["styles"],var_825["view"],var_561);
            ...
            _communication.addHabboConnectionMessageEvent(new ClubGiftSelectedEvent(method_6));
            registerUpdateReceiver(var_394,1);
            registerUpdateReceiver(this,2);
            var_338.events.addEventListener(BadgeImageReadyEvent.const_110,onBadgeImage);
            var_561.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
