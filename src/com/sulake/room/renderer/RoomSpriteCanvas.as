package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_1794:Number = -10000000;
      
      private var var_2344:int = 0;
      
      private var var_473:RoomObjectCache;
      
      private var var_679:int;
      
      private var var_259:Sprite;
      
      private var var_984:IRoomRenderingCanvasMouseListener = null;
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_259 != null)
         {
            var_259.graphics.clear();
         }
         else
         {
            var_259 = new Sprite();
            var_259.name = "mask";
            _master.addChild(var_259);
         }
         var_259.graphics.beginFill(0);
         var_259.graphics.drawRect(0,0,param1,param2);
         var_679 = param1;
         var_677 = param2;
         var_53.graphics.clear();
         var_53.graphics.beginFill(var_2344);
      ...
      {
         var _loc11_:Number = param1 - var_679 / 2;
         var _loc12_:Number = param2 - var_677 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_679 != var_1793 || var_677 != var_1792)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_393.sortOn("z",0 | 0);
         if(_loc6_ < var_393.length)
         {
            var_393.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_393[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_678.push(_loc12_ - _loc2_);
         if(var_678.length == const_758)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_758)
            {
               _loc13_ += var_678[_loc14_];
               _loc14_++;
            }
         ...
         while(_loc1_ < var_300.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_984 != null)
                  {
                     var_984.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1446,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_393.length)
         {
            return null;
         }
         return var_393[param1] as SortableSprite;
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1791 || param2 != var_1794)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         if(_loc5_ == null)
         {
            var_473.removeObjectCache(param2);
            return 0;
         }
         var _loc6_:RoomObjectCacheItem = var_473.getObjectCache(param2);
         ...
         _loc12_ += int(var_679 / 2);
         _loc13_ += int(var_677 / 2);
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc17_:* = null;
         var _loc18_:int = 0;
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_679 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_677))
                  {
