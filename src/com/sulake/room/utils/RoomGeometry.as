package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_893:Number = 32;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_83 = new Vector3d();
         var_1049 = new Vector3d();
         var_1544 = 1;
         var_1542 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1543 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_419 != param1 * var_1543)
         {
            var_419 = param1 * var_1543;
            ++var_78;
         }
      }
      ...
      {
         if(var_420 != param1 * var_1544)
         {
            var_420 = param1 * var_1544;
            ++var_78;
         }
      }
      ...
      {
         if(var_422 != param1 * var_1542)
         {
            var_422 = param1 * var_1542;
            ++var_78;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1049.assign(_loc22_);
         }
         else
         {
            var_1049.assign(_loc17_);
         }
         ++var_78;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_422;
         _loc2_.z *= var_419;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1049);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_422;
            _loc2_.z *= var_419;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1049);
         }
      ...
      {
         return new Vector3d(0 * var_420,0 * var_422,0 * var_419);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_420,0 * var_422,0 * var_419);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_83;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_420,param2.y * var_422,param2.z * var_419);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_420,param3.y * var_422,param3.z * var_419);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_420,param4.y * var_422,param4.z * var_419);
