package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_685))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_685,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_90 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_685,"EOF"));
            }
         }
      }
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_489.parse(param1))
         {
            ...
            if(false)
            {
               var_129["null"] = var_489;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1220,var_489));
            var_489 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_46 != null && var_129 != null && param1 < var_46.length)
         {
